        ...
        if ( l == 'S' ){
			...
			for ( int j = 0; j < bra[a].size(); j += 3 ){
				if ( bra[a][j] == '*' && bra[a][j+1] == '.' ){
                    if ( bra[a+1][j] == '.' && bra[a+1][j+1] == '.' ) cout << "1";
                    if ( bra[a+1][j] == '*' && bra[a+1][j+1] == '.' ) cout << "2";
                    if ( bra[a+1][j] == '.' && bra[a+1][j+1] == '*' ) cout << "5";
                    if ( bra[a+1][j] == '*' && bra[a+1][j+1] == '*' ) cout << "8";
				}
				if ( bra[a][j] == '*' && bra[a][j+1] == '*' ){
                    if ( bra[a+1][j] == '.' && bra[a+1][j+1] == '.' ) cout << "3";
                    if ( bra[a+1][j] == '.' && bra[a+1][j+1] == '*' ) cout << "4";
                    if ( bra[a+1][j] == '*' && bra[a+1][j+1] == '.' ) cout << "6";
                    if ( bra[a+1][j] == '*' && bra[a+1][j+1] == '*' ) cout << "7";
				}
				if ( bra[a][j] == '.' && bra[a][j+1] == '*' ){
                    if ( bra[a+1][j] == '*' && bra[a+1][j+1] == '.' ) cout << "9";
                    if ( bra[a+1][j] == '*' && bra[a+1][j+1] == '*' ) cout << "0";
				}
			}
			cout << "\n";
        }
